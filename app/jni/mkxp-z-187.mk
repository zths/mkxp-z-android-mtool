...
LOCAL_C_INCLUDES := \
	$(LOCAL_BUILD_PATH)/include/ruby-1.8.7 \
...
LOCAL_SRC_FILES := \
	...
	$(LOCAL_PATH)/src/MtoolProc.cpp \
	$(LOCAL_PATH)/src/MToolClient.cpp \
...
LOCAL_SHARED_LIBRARIES := SDL2 SDL2_ttf SDL2_image SDL2_sound openal ruby187
